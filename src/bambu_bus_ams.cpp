...
void get_package_online_detect(unsigned char *buf, int length)
{
    ...
    if (buf[5] == 0x00)
    {
        ...
        if (act == ams_online_detect::QueryAction::stay_silent) return;
...
//0x50 // 80
//0x5A // 90
unsigned char long_packge_version_version_and_name_AMS08[] = {0x53, 0x06, 0x00, 0x01, // Firmware version 01.00.06.83
